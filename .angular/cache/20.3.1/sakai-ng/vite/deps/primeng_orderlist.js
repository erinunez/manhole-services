...
__name(OrderList__svg_svg_2_Template, "OrderList__svg_svg_2_Template");
function OrderList_3_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_3_ng_template_0_Template, "OrderList_3_ng_template_0_Template");
function OrderList_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, OrderList_3_ng_template_0_Template, 0, 0, "ng-template");
  }
}
__name(OrderList_3_Template, "OrderList_3_Template");
...
__name(OrderList__svg_svg_5_Template, "OrderList__svg_svg_5_Template");
function OrderList_6_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_6_ng_template_0_Template, "OrderList_6_ng_template_0_Template");
function OrderList_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, OrderList_6_ng_template_0_Template, 0, 0, "ng-template");
  }
}
__name(OrderList_6_Template, "OrderList_6_Template");
...
__name(OrderList__svg_svg_8_Template, "OrderList__svg_svg_8_Template");
function OrderList_9_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_9_ng_template_0_Template, "OrderList_9_ng_template_0_Template");
function OrderList_9_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, OrderList_9_ng_template_0_Template, 0, 0, "ng-template");
  }
}
__name(OrderList_9_Template, "OrderList_9_Template");
...
__name(OrderList__svg_svg_11_Template, "OrderList__svg_svg_11_Template");
function OrderList_12_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_12_ng_template_0_Template, "OrderList_12_ng_template_0_Template");
function OrderList_12_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, OrderList_12_ng_template_0_Template, 0, 0, "ng-template");
  }
}
__name(OrderList_12_Template, "OrderList_12_Template");
function OrderList_ng_container_15_ng_template_1_0_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_ng_container_15_ng_template_1_0_ng_template_0_Template, "OrderList_ng_container_15_ng_template_1_0_ng_template_0_Template");
...
__name(OrderList_ng_container_15_ng_template_1_0_Template, "OrderList_ng_container_15_ng_template_1_0_Template");
...
__name(OrderList_ng_container_15_ng_template_1_Template, "OrderList_ng_container_15_ng_template_1_Template");
...
__name(OrderList_ng_container_15_Template, "OrderList_ng_container_15_Template");
function OrderList_ng_container_16_ng_template_1_0_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_ng_container_16_ng_template_1_0_ng_template_0_Template, "OrderList_ng_container_16_ng_template_1_0_ng_template_0_Template");
...
__name(OrderList_ng_container_16_ng_template_1_0_Template, "OrderList_ng_container_16_ng_template_1_0_Template");
...
__name(OrderList_ng_container_16_ng_template_1_Template, "OrderList_ng_container_16_ng_template_1_Template");
...
__name(OrderList_ng_container_16_Template, "OrderList_ng_container_16_Template");
function OrderList_ng_container_17_ng_template_1_0_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_ng_container_17_ng_template_1_0_ng_template_0_Template, "OrderList_ng_container_17_ng_template_1_0_ng_template_0_Template");
...
__name(OrderList_ng_container_17_ng_template_1_0_Template, "OrderList_ng_container_17_ng_template_1_0_Template");
...
__name(OrderList_ng_container_17_ng_template_1_Template, "OrderList_ng_container_17_ng_template_1_Template");
...
__name(OrderList_ng_container_17_Template, "OrderList_ng_container_17_Template");
function OrderList_ng_container_18_ng_template_1_0_ng_template_0_Template(rf, ctx) {
}
__name(OrderList_ng_container_18_ng_template_1_0_ng_template_0_Template, "OrderList_ng_container_18_ng_template_1_0_ng_template_0_Template");
...
__name(OrderList_ng_container_18_ng_template_1_0_Template, "OrderList_ng_container_18_ng_template_1_0_Template");
...
__name(OrderList_ng_container_18_ng_template_1_Template, "OrderList_ng_container_18_ng_template_1_Template");
...
__name(OrderList_ng_container_18_Template, "OrderList_ng_container_18_Template");
var classes = {
  root: /* @__PURE__ */ __name(() => ["p-orderlist p-component"], "root"),
  controls: "p-orderlist-controls"
};
var _OrderListStyle = class _OrderListStyle extends BaseStyle {
  name = "orderlist";
  theme = style;
  classes = classes;
};
__name(_OrderListStyle, "OrderListStyle");
__publicField(_OrderListStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵOrderListStyle_BaseFactory;
  return /* @__PURE__ */ __name(function OrderListStyle_Factory(__ngFactoryType__) {
  ...
  }, "OrderListStyle_Factory");
})());
__publicField(_OrderListStyle, "ɵprov", ɵɵdefineInjectable({
  token: _OrderListStyle,
  factory: _OrderListStyle.ɵfac
}));
var OrderListStyle = _OrderListStyle;
(() => {
...
var _OrderList = class _OrderList extends BaseComponent {
  /**
  ...
  ngOnInit() {
    ...
    if (this.filterBy) {
      this.filterOptions = {
        filter: /* @__PURE__ */ __name((value) => this.onFilterKeyup(value), "filter"),
...
__name(_OrderList, "OrderList");
__publicField(_OrderList, "ɵfac", /* @__PURE__ */ (() => {
  let ɵOrderList_BaseFactory;
  return /* @__PURE__ */ __name(function OrderList_Factory(__ngFactoryType__) {
...
__publicField(_OrderList, "ɵcmp", ɵɵdefineComponent({
  ...
  contentQueries: /* @__PURE__ */ __name(function OrderList_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "OrderList_ContentQueries"),
  viewQuery: /* @__PURE__ */ __name(function OrderList_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c10, 5);
      ɵɵviewQuery(_c3, 5);
    }
  ...
  hostVars: 3,
  hostBindings: /* @__PURE__ */ __name(function OrderList_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("data-pc-section", "root");
      ɵɵclassMap(ctx.cn(ctx.cx("root"), ctx.styleClass));
    }
  }, "OrderList_HostBindings"),
  inputs: {
    header: "header",
  ...
  template: /* @__PURE__ */ __name(function OrderList_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = ɵɵgetCurrentView();
      ɵɵelementStart(0, "div")(1, "button", 5);
      ɵɵlistener("click", /* @__PURE__ */ __name(function OrderList_Template_button_click_1_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.moveUp());
      }, "OrderList_Template_button_click_1_listener"));
      ɵɵtemplate(2, OrderList__svg_svg_2_Template, 1, 1, "svg", 6)(3, OrderList_3_Template, 1, 0, null, 7);
      ɵɵelementEnd();
      ɵɵelementStart(4, "button", 5);
      ɵɵlistener("click", /* @__PURE__ */ __name(function OrderList_Template_button_click_4_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.moveTop());
      }, "OrderList_Template_button_click_4_listener"));
      ɵɵtemplate(5, OrderList__svg_svg_5_Template, 1, 1, "svg", 8)(6, OrderList_6_Template, 1, 0, null, 7);
      ɵɵelementEnd();
      ɵɵelementStart(7, "button", 5);
      ɵɵlistener("click", /* @__PURE__ */ __name(function OrderList_Template_button_click_7_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.moveDown());
      }, "OrderList_Template_button_click_7_listener"));
      ɵɵtemplate(8, OrderList__svg_svg_8_Template, 1, 1, "svg", 9)(9, OrderList_9_Template, 1, 0, null, 7);
      ɵɵelementEnd();
      ɵɵelementStart(10, "button", 5);
      ɵɵlistener("click", /* @__PURE__ */ __name(function OrderList_Template_button_click_10_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.moveBottom());
      }, "OrderList_Template_button_click_10_listener"));
      ...
      ɵɵtwoWayListener("ngModelChange", /* @__PURE__ */ __name(function OrderList_Template_p_listbox_ngModelChange_13_listener($event) {
        ɵɵrestoreView(_r1);
        ɵɵtwoWayBindingSet(ctx.d_selection, $event) || (ctx.d_selection = $event);
        return ɵɵresetView($event);
      }, "OrderList_Template_p_listbox_ngModelChange_13_listener"));
      ɵɵlistener("onFocus", /* @__PURE__ */ __name(function OrderList_Template_p_listbox_onFocus_13_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onListFocus($event));
      }, "OrderList_Template_p_listbox_onFocus_13_listener"))("onBlur", /* @__PURE__ */ __name(function OrderList_Template_p_listbox_onBlur_13_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onListBlur($event));
      }, "OrderList_Template_p_listbox_onBlur_13_listener"))("onChange", /* @__PURE__ */ __name(function OrderList_Template_p_listbox_onChange_13_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onChangeSelection($event));
      }, "OrderList_Template_p_listbox_onChange_13_listener"))("onDrop", /* @__PURE__ */ __name(function OrderList_Template_p_listbox_onDrop_13_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onDrop($event));
      }, "OrderList_Template_p_listbox_onDrop_13_listener"));
    ...
    if (rf & 2) {
      ...
      ɵɵproperty("id", ctx.id + "_list")("listStyle", ctx.listStyle)("striped", ctx.stripedRows)("tabindex", ctx.tabindex);
      ɵɵariaProperty("ariaLabel", ctx.ariaLabel);
      ɵɵproperty("disabled", ctx.disabled)("metaKeySelection", ctx.metaKeySelection)("scrollHeight", ctx.scrollHeight)("autoOptionFocus", ctx.autoOptionFocus)("filter", ctx.filterBy)("filterBy", ctx.filterBy)("filterLocale", ctx.filterLocale)("filterPlaceHolder", ctx.filterPlaceholder)("dragdrop", ctx.dragdrop);
      ɵɵadvance(2);
...
__name(_OrderListModule, "OrderListModule");
__publicField(_OrderListModule, "ɵfac", /* @__PURE__ */ __name(function OrderListModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _OrderListModule)();
}, "OrderListModule_Factory"));
