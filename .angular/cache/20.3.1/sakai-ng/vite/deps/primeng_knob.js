...
__name(Knob__svg_text_3_Template, "Knob__svg_text_3_Template");
var classes = {
...
var _KnobStyle = class _KnobStyle extends BaseStyle {
  name = "knob";
  theme = style;
  classes = classes;
};
__name(_KnobStyle, "KnobStyle");
__publicField(_KnobStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵKnobStyle_BaseFactory;
  return /* @__PURE__ */ __name(function KnobStyle_Factory(__ngFactoryType__) {
    return (ɵKnobStyle_BaseFactory || (ɵKnobStyle_BaseFactory = ɵɵgetInheritedFactory(_KnobStyle)))(__ngFactoryType__ || _KnobStyle);
  }, "KnobStyle_Factory");
})());
__publicField(_KnobStyle, "ɵprov", ɵɵdefineInjectable({
  token: _KnobStyle,
  factory: _KnobStyle.ɵfac
}));
var KnobStyle = _KnobStyle;
(() => {
...
var _Knob = class _Knob extends BaseEditableHolder {
  /**
...
__name(_Knob, "Knob");
__publicField(_Knob, "ɵfac", /* @__PURE__ */ (() => {
  let ɵKnob_BaseFactory;
  return /* @__PURE__ */ __name(function Knob_Factory(__ngFactoryType__) {
...
__publicField(_Knob, "ɵcmp", ɵɵdefineComponent({
  ...
  selectors: [["p-knob"]],
  hostVars: 4,
  hostBindings: /* @__PURE__ */ __name(function Knob_HostBindings(rf, ctx) {
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function Knob_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵnamespaceSVG();
      ɵɵelementStart(0, "svg", 0);
      ɵɵlistener("click", /* @__PURE__ */ __name(function Knob_Template_svg_click_0_listener($event) {
        return ctx.onClick($event);
      }, "Knob_Template_svg_click_0_listener"))("keydown", /* @__PURE__ */ __name(function Knob_Template_svg_keydown_0_listener($event) {
        return ctx.onKeyDown($event);
      }, "Knob_Template_svg_keydown_0_listener"))("mousedown", /* @__PURE__ */ __name(function Knob_Template_svg_mousedown_0_listener($event) {
        return ctx.onMouseDown($event);
      }, "Knob_Template_svg_mousedown_0_listener"))("mouseup", /* @__PURE__ */ __name(function Knob_Template_svg_mouseup_0_listener($event) {
        return ctx.onMouseUp($event);
      }, "Knob_Template_svg_mouseup_0_listener"))("touchstart", /* @__PURE__ */ __name(function Knob_Template_svg_touchstart_0_listener($event) {
        return ctx.onTouchStart($event);
      }, "Knob_Template_svg_touchstart_0_listener"))("touchend", /* @__PURE__ */ __name(function Knob_Template_svg_touchend_0_listener($event) {
        return ctx.onTouchEnd($event);
      }, "Knob_Template_svg_touchend_0_listener"));
...
__name(_KnobModule, "KnobModule");
__publicField(_KnobModule, "ɵfac", /* @__PURE__ */ __name(function KnobModule_Factory(__ngFactoryType__) {
