...
__name(Card_div_0_ng_container_2_Template, "Card_div_0_ng_container_2_Template");
...
__name(Card_div_0_Template, "Card_div_0_Template");
...
__name(Card_div_2_ng_container_1_Template, "Card_div_2_ng_container_1_Template");
function Card_div_2_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Card_div_2_ng_container_2_Template, "Card_div_2_ng_container_2_Template");
...
__name(Card_div_2_Template, "Card_div_2_Template");
...
__name(Card_div_3_ng_container_1_Template, "Card_div_3_ng_container_1_Template");
function Card_div_3_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Card_div_3_ng_container_2_Template, "Card_div_3_ng_container_2_Template");
...
__name(Card_div_3_Template, "Card_div_3_Template");
function Card_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Card_ng_container_6_Template, "Card_ng_container_6_Template");
function Card_div_7_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Card_div_7_ng_container_2_Template, "Card_div_7_ng_container_2_Template");
...
__name(Card_div_7_Template, "Card_div_7_Template");
var theme = (
  /*css*/
  `
    ${style}
...
var _CardStyle = class _CardStyle extends BaseStyle {
  name = "card";
  theme = theme;
  classes = classes;
};
__name(_CardStyle, "CardStyle");
__publicField(_CardStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵCardStyle_BaseFactory;
  return /* @__PURE__ */ __name(function CardStyle_Factory(__ngFactoryType__) {
    return (ɵCardStyle_BaseFactory || (ɵCardStyle_BaseFactory = ɵɵgetInheritedFactory(_CardStyle)))(__ngFactoryType__ || _CardStyle);
  }, "CardStyle_Factory");
})());
__publicField(_CardStyle, "ɵprov", ɵɵdefineInjectable({
  token: _CardStyle,
...
var _Card = class _Card extends BaseComponent {
  /**
   * Header of the card.
   * @group Props
   */
...
__name(_Card, "Card");
__publicField(_Card, "ɵfac", /* @__PURE__ */ (() => {
  let ɵCard_BaseFactory;
  return /* @__PURE__ */ __name(function Card_Factory(__ngFactoryType__) {
...
__publicField(_Card, "ɵcmp", ɵɵdefineComponent({
  type: _Card,
  selectors: [["p-card"]],
  contentQueries: /* @__PURE__ */ __name(function Card_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  hostVars: 5,
  hostBindings: /* @__PURE__ */ __name(function Card_HostBindings(rf, ctx) {
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function Card_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c5);
...
__name(_CardModule, "CardModule");
__publicField(_CardModule, "ɵfac", /* @__PURE__ */ __name(function CardModule_Factory(__ngFactoryType__) {
