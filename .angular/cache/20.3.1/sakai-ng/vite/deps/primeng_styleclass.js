...
__name(_StyleClass, "StyleClass");
__publicField(_StyleClass, "ɵfac", /* @__PURE__ */ __name(function StyleClass_Factory(__ngFactoryType__) {
...
__publicField(_StyleClass, "ɵdir", ɵɵdefineDirective({
  ...
  hostBindings: /* @__PURE__ */ __name(function StyleClass_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("click", /* @__PURE__ */ __name(function StyleClass_click_HostBindingHandler($event) {
        return ctx.clickListener($event);
      }, "StyleClass_click_HostBindingHandler"));
    }
  }, "StyleClass_HostBindings"),
  inputs: {
...
__name(_StyleClassModule, "StyleClassModule");
__publicField(_StyleClassModule, "ɵfac", /* @__PURE__ */ __name(function StyleClassModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _StyleClassModule)();
}, "StyleClassModule_Factory"));
