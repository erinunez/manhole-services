...
var N = /* @__PURE__ */ __name((e, t2, n) => t2 in e ? oe(e, t2, { enumerable: true, configurable: true, writable: true, value: n }) : e[t2] = n, "N");
var d = /* @__PURE__ */ __name((e, t2) => {
...
function ht(t2, e) {
  if (t2) {
    t2.style.opacity = "0";
    let o = +/* @__PURE__ */ new Date(), n = "0", r = /* @__PURE__ */ __name(function() {
...
function g2() {
  let r = [], i2 = /* @__PURE__ */ __name((e, n, t2 = 999) => {
    let s4 = u(e, n, t2), o = s4.value + (s4.key === e ? 0 : t2) + 1;
    return r.push({ key: e, value: o }), o;
  }, "i"), d2 = /* @__PURE__ */ __name((e) => {
    r = r.filter((n) => n.value !== e);
  }, "d"), a2 = /* @__PURE__ */ __name((e, n) => u(e, n).value, "a"), u = /* @__PURE__ */ __name((e, n, t2 = 0) => [...r].reverse().find((s4) => n ? true : s4.key === e) || { key: e, value: t2 }, "u"), l2 = /* @__PURE__ */ __name((e) => e && parseInt(e.style.zIndex, 10) || 0, "l");
  return { get: l2, set: /* @__PURE__ */ __name((e, n, t2) => {
...
//# sourceMappingURL=chunk-XU74YL5C.js.map
