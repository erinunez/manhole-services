...
var _c13 = /* @__PURE__ */ __name(() => ({
  position: "top"
}), "_c13");
var _c14 = /* @__PURE__ */ __name((a0) => ({
  $implicit: a0
}), "_c14");
var _c15 = /* @__PURE__ */ __name(() => ({
  position: "bottom"
}), "_c15");
...
__name(DataView_Conditional_0_Conditional_2_Template, "DataView_Conditional_0_Conditional_2_Template");
function DataView_Conditional_0_Conditional_3_2_ng_template_0_Template(rf, ctx) {
}
__name(DataView_Conditional_0_Conditional_3_2_ng_template_0_Template, "DataView_Conditional_0_Conditional_3_2_ng_template_0_Template");
...
__name(DataView_Conditional_0_Conditional_3_2_Template, "DataView_Conditional_0_Conditional_3_2_Template");
...
__name(DataView_Conditional_0_Conditional_3_Template, "DataView_Conditional_0_Conditional_3_Template");
...
__name(DataView_Conditional_0_Template, "DataView_Conditional_0_Template");
function DataView_Conditional_1_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(DataView_Conditional_1_ng_container_2_Template, "DataView_Conditional_1_ng_container_2_Template");
...
__name(DataView_Conditional_1_Template, "DataView_Conditional_1_Template");
function DataView_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "p-paginator", 5);
    ɵɵlistener("onPageChange", /* @__PURE__ */ __name(function DataView_Conditional_2_Template_p_paginator_onPageChange_0_listener($event) {
      ɵɵrestoreView(_r2);
      const ctx_r0 = ɵɵnextContext();
      return ɵɵresetView(ctx_r0.paginate($event));
    }, "DataView_Conditional_2_Template_p_paginator_onPageChange_0_listener"));
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
__name(DataView_Conditional_2_Template, "DataView_Conditional_2_Template");
function DataView_Conditional_4_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(DataView_Conditional_4_ng_container_0_Template, "DataView_Conditional_4_ng_container_0_Template");
...
__name(DataView_Conditional_4_Template, "DataView_Conditional_4_Template");
function DataView_Conditional_5_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(DataView_Conditional_5_ng_container_0_Template, "DataView_Conditional_5_ng_container_0_Template");
...
__name(DataView_Conditional_5_Template, "DataView_Conditional_5_Template");
...
__name(DataView_Conditional_6_ng_container_1_Template, "DataView_Conditional_6_ng_container_1_Template");
function DataView_Conditional_6_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0, null, 0);
  }
}
__name(DataView_Conditional_6_ng_container_2_Template, "DataView_Conditional_6_ng_container_2_Template");
...
__name(DataView_Conditional_6_Template, "DataView_Conditional_6_Template");
function DataView_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "p-paginator", 5);
    ɵɵlistener("onPageChange", /* @__PURE__ */ __name(function DataView_Conditional_7_Template_p_paginator_onPageChange_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r0 = ɵɵnextContext();
      return ɵɵresetView(ctx_r0.paginate($event));
    }, "DataView_Conditional_7_Template_p_paginator_onPageChange_0_listener"));
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
__name(DataView_Conditional_7_Template, "DataView_Conditional_7_Template");
function DataView_Conditional_8_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(DataView_Conditional_8_ng_container_2_Template, "DataView_Conditional_8_ng_container_2_Template");
...
__name(DataView_Conditional_8_Template, "DataView_Conditional_8_Template");
var classes = {
  ...
  pcPaginator: /* @__PURE__ */ __name(({
    position
  }) => "p-dataview-paginator-" + position, "pcPaginator"),
  content: "p-dataview-content",
  emptyMessage: "p-dataview-empty-message",
  footer: "p-dataview-footer"
};
var _DataViewStyle = class _DataViewStyle extends BaseStyle {
  name = "dataview";
  theme = style;
  classes = classes;
};
__name(_DataViewStyle, "DataViewStyle");
__publicField(_DataViewStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵDataViewStyle_BaseFactory;
  return /* @__PURE__ */ __name(function DataViewStyle_Factory(__ngFactoryType__) {
  ...
  }, "DataViewStyle_Factory");
})());
__publicField(_DataViewStyle, "ɵprov", ɵɵdefineInjectable({
  token: _DataViewStyle,
  factory: _DataViewStyle.ɵfac
}));
var DataViewStyle = _DataViewStyle;
(() => {
...
var _DataView = class _DataView extends BaseComponent {
  /**
...
__publicField(_DataView, "ɵfac", /* @__PURE__ */ (() => {
  let ɵDataView_BaseFactory;
  return /* @__PURE__ */ __name(function DataView_Factory(__ngFactoryType__) {
...
__publicField(_DataView, "ɵcmp", ɵɵdefineComponent({
  ...
  contentQueries: /* @__PURE__ */ __name(function DataView_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "DataView_ContentQueries"),
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function DataView_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassMap(ctx.cn(ctx.cx("root"), ctx.styleClass));
    }
  }, "DataView_HostBindings"),
  inputs: {
  ...
  template: /* @__PURE__ */ __name(function DataView_Template(rf, ctx) {
    if (rf & 1) {
...
__name(_DataViewModule, "DataViewModule");
__publicField(_DataViewModule, "ɵfac", /* @__PURE__ */ __name(function DataViewModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DataViewModule)();
}, "DataViewModule_Factory"));
