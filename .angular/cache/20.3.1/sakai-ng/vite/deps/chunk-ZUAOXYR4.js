...
__name(Message_Conditional_0_Conditional_2_ng_container_0_Template, "Message_Conditional_0_Conditional_2_ng_container_0_Template");
...
__name(Message_Conditional_0_Conditional_2_Template, "Message_Conditional_0_Conditional_2_Template");
...
__name(Message_Conditional_0_Conditional_3_Template, "Message_Conditional_0_Conditional_3_Template");
...
__name(Message_Conditional_0_div_4_span_1_Template, "Message_Conditional_0_div_4_span_1_Template");
...
__name(Message_Conditional_0_div_4_Template, "Message_Conditional_0_div_4_Template");
...
__name(Message_Conditional_0_ng_template_5_span_0_Template, "Message_Conditional_0_ng_template_5_span_0_Template");
...
__name(Message_Conditional_0_ng_template_5_Template, "Message_Conditional_0_ng_template_5_Template");
function Message_Conditional_0_Conditional_7_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Message_Conditional_0_Conditional_7_ng_container_0_Template, "Message_Conditional_0_Conditional_7_ng_container_0_Template");
...
__name(Message_Conditional_0_Conditional_7_Template, "Message_Conditional_0_Conditional_7_Template");
...
__name(Message_Conditional_0_Conditional_8_Template, "Message_Conditional_0_Conditional_8_Template");
...
__name(Message_Conditional_0_Conditional_9_Conditional_1_Template, "Message_Conditional_0_Conditional_9_Conditional_1_Template");
function Message_Conditional_0_Conditional_9_Conditional_2_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Message_Conditional_0_Conditional_9_Conditional_2_ng_container_0_Template, "Message_Conditional_0_Conditional_9_Conditional_2_ng_container_0_Template");
...
__name(Message_Conditional_0_Conditional_9_Conditional_2_Template, "Message_Conditional_0_Conditional_9_Conditional_2_Template");
...
__name(Message_Conditional_0_Conditional_9_Conditional_3_Template, "Message_Conditional_0_Conditional_9_Conditional_3_Template");
function Message_Conditional_0_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 12);
    ɵɵlistener("click", /* @__PURE__ */ __name(function Message_Conditional_0_Conditional_9_Template_button_click_0_listener($event) {
      ɵɵrestoreView(_r2);
      const ctx_r0 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r0.close($event));
    }, "Message_Conditional_0_Conditional_9_Template_button_click_0_listener"));
...
__name(Message_Conditional_0_Conditional_9_Template, "Message_Conditional_0_Conditional_9_Template");
...
__name(Message_Conditional_0_Template, "Message_Conditional_0_Template");
var classes = {
...
var _MessageStyle = class _MessageStyle extends BaseStyle {
  name = "message";
  theme = style2;
  classes = classes;
};
__name(_MessageStyle, "MessageStyle");
__publicField(_MessageStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMessageStyle_BaseFactory;
  return /* @__PURE__ */ __name(function MessageStyle_Factory(__ngFactoryType__) {
  ...
  }, "MessageStyle_Factory");
})());
__publicField(_MessageStyle, "ɵprov", ɵɵdefineInjectable({
  token: _MessageStyle,
  factory: _MessageStyle.ɵfac
}));
var MessageStyle = _MessageStyle;
(() => {
...
var _Message = class _Message extends BaseComponent {
  /**
...
__publicField(_Message, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMessage_BaseFactory;
  return /* @__PURE__ */ __name(function Message_Factory(__ngFactoryType__) {
    return (ɵMessage_BaseFactory || (ɵMessage_BaseFactory = ɵɵgetInheritedFactory(_Message)))(__ngFactoryType__ || _Message);
  }, "Message_Factory");
})());
__publicField(_Message, "ɵcmp", ɵɵdefineComponent({
  type: _Message,
  selectors: [["p-message"]],
  contentQueries: /* @__PURE__ */ __name(function Message_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  template: /* @__PURE__ */ __name(function Message_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
...
__name(_MessageModule, "MessageModule");
__publicField(_MessageModule, "ɵfac", /* @__PURE__ */ __name(function MessageModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MessageModule)();
}, "MessageModule_Factory"));
...
//# sourceMappingURL=chunk-ZUAOXYR4.js.map
