...
__name(Drawer_div_0_Conditional_2_ng_container_0_Template, "Drawer_div_0_Conditional_2_ng_container_0_Template");
...
__name(Drawer_div_0_Conditional_2_Template, "Drawer_div_0_Conditional_2_Template");
function Drawer_div_0_Conditional_3_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Drawer_div_0_Conditional_3_ng_container_1_Template, "Drawer_div_0_Conditional_3_ng_container_1_Template");
...
__name(Drawer_div_0_Conditional_3_div_2_Template, "Drawer_div_0_Conditional_3_div_2_Template");
...
__name(Drawer_div_0_Conditional_3_p_button_3_ng_template_1__svg_svg_0_Template, "Drawer_div_0_Conditional_3_p_button_3_ng_template_1__svg_svg_0_Template");
function Drawer_div_0_Conditional_3_p_button_3_ng_template_1_1_ng_template_0_Template(rf, ctx) {
}
__name(Drawer_div_0_Conditional_3_p_button_3_ng_template_1_1_ng_template_0_Template, "Drawer_div_0_Conditional_3_p_button_3_ng_template_1_1_ng_template_0_Template");
...
__name(Drawer_div_0_Conditional_3_p_button_3_ng_template_1_1_Template, "Drawer_div_0_Conditional_3_p_button_3_ng_template_1_1_Template");
...
__name(Drawer_div_0_Conditional_3_p_button_3_ng_template_1_Template, "Drawer_div_0_Conditional_3_p_button_3_ng_template_1_Template");
function Drawer_div_0_Conditional_3_p_button_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "p-button", 9);
    ɵɵlistener("onClick", /* @__PURE__ */ __name(function Drawer_div_0_Conditional_3_p_button_3_Template_p_button_onClick_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r1 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r1.close($event));
    }, "Drawer_div_0_Conditional_3_p_button_3_Template_p_button_onClick_0_listener"))("keydown.enter", /* @__PURE__ */ __name(function Drawer_div_0_Conditional_3_p_button_3_Template_p_button_keydown_enter_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r1 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r1.close($event));
    }, "Drawer_div_0_Conditional_3_p_button_3_Template_p_button_keydown_enter_0_listener"));
...
__name(Drawer_div_0_Conditional_3_p_button_3_Template, "Drawer_div_0_Conditional_3_p_button_3_Template");
function Drawer_div_0_Conditional_3_ng_container_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Drawer_div_0_Conditional_3_ng_container_6_Template, "Drawer_div_0_Conditional_3_ng_container_6_Template");
function Drawer_div_0_Conditional_3_ng_container_7_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Drawer_div_0_Conditional_3_ng_container_7_ng_container_2_Template, "Drawer_div_0_Conditional_3_ng_container_7_ng_container_2_Template");
...
__name(Drawer_div_0_Conditional_3_ng_container_7_Template, "Drawer_div_0_Conditional_3_ng_container_7_Template");
...
__name(Drawer_div_0_Conditional_3_Template, "Drawer_div_0_Conditional_3_Template");
function Drawer_div_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 3, 0);
    ɵɵlistener("@panelState.start", /* @__PURE__ */ __name(function Drawer_div_0_Template_div_animation_panelState_start_0_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onAnimationStart($event));
    }, "Drawer_div_0_Template_div_animation_panelState_start_0_listener"))("@panelState.done", /* @__PURE__ */ __name(function Drawer_div_0_Template_div_animation_panelState_done_0_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onAnimationEnd($event));
    }, "Drawer_div_0_Template_div_animation_panelState_done_0_listener"))("keydown", /* @__PURE__ */ __name(function Drawer_div_0_Template_div_keydown_0_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onKeyDown($event));
    }, "Drawer_div_0_Template_div_keydown_0_listener"));
...
__name(Drawer_div_0_Template, "Drawer_div_0_Template");
var theme = (
  /*css*/
  `
    ${style2}
...
var classes = {
  ...
  }, `p-drawer-${instance.position}`], "root"),
...
var _DrawerStyle = class _DrawerStyle extends BaseStyle {
  name = "drawer";
  theme = theme;
  classes = classes;
};
__name(_DrawerStyle, "DrawerStyle");
__publicField(_DrawerStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵDrawerStyle_BaseFactory;
  return /* @__PURE__ */ __name(function DrawerStyle_Factory(__ngFactoryType__) {
...
__publicField(_DrawerStyle, "ɵprov", ɵɵdefineInjectable({
  token: _DrawerStyle,
  factory: _DrawerStyle.ɵfac
}));
var DrawerStyle = _DrawerStyle;
(() => {
...
var _Drawer = class _Drawer extends BaseComponent {
  /**
...
__name(_Drawer, "Drawer");
__publicField(_Drawer, "ɵfac", /* @__PURE__ */ (() => {
  let ɵDrawer_BaseFactory;
  return /* @__PURE__ */ __name(function Drawer_Factory(__ngFactoryType__) {
    return (ɵDrawer_BaseFactory || (ɵDrawer_BaseFactory = ɵɵgetInheritedFactory(_Drawer)))(__ngFactoryType__ || _Drawer);
  }, "Drawer_Factory");
})());
__publicField(_Drawer, "ɵcmp", ɵɵdefineComponent({
  type: _Drawer,
  selectors: [["p-drawer"]],
  contentQueries: /* @__PURE__ */ __name(function Drawer_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "Drawer_ContentQueries"),
  viewQuery: /* @__PURE__ */ __name(function Drawer_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c5, 5);
      ɵɵviewQuery(_c6, 5);
    }
  ...
  template: /* @__PURE__ */ __name(function Drawer_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
...
__name(_DrawerModule, "DrawerModule");
__publicField(_DrawerModule, "ɵfac", /* @__PURE__ */ __name(function DrawerModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DrawerModule)();
}, "DrawerModule_Factory"));
__publicField(_DrawerModule, "ɵmod", ɵɵdefineNgModule({
  type: _DrawerModule,
  imports: [Drawer, SharedModule],
  exports: [Drawer, SharedModule]
}));
__publicField(_DrawerModule, "ɵinj", ɵɵdefineInjector({
