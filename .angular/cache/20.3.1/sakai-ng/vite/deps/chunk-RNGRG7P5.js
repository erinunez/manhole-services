...
var _BaseInput = class _BaseInput extends BaseEditableHolder {
...
__name(_BaseInput, "BaseInput");
__publicField(_BaseInput, "ɵfac", /* @__PURE__ */ (() => {
  let ɵBaseInput_BaseFactory;
  return /* @__PURE__ */ __name(function BaseInput_Factory(__ngFactoryType__) {
    return (ɵBaseInput_BaseFactory || (ɵBaseInput_BaseFactory = ɵɵgetInheritedFactory(_BaseInput)))(__ngFactoryType__ || _BaseInput);
  }, "BaseInput_Factory");
})());
__publicField(_BaseInput, "ɵdir", ɵɵdefineDirective({
  type: _BaseInput,
  inputs: {
    fluid: [1, "fluid"],
    variant: [1, "variant"],
...
//# sourceMappingURL=chunk-RNGRG7P5.js.map
