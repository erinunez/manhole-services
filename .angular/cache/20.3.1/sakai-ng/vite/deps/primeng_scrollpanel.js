...
__name(ScrollPanel_Conditional_3_Template, "ScrollPanel_Conditional_3_Template");
function ScrollPanel_ng_container_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(ScrollPanel_ng_container_4_Template, "ScrollPanel_ng_container_4_Template");
var theme = (
  /*css*/
  `
    ${style}
...
var _ScrollPanelStyle = class _ScrollPanelStyle extends BaseStyle {
  name = "scrollpanel";
  theme = theme;
  classes = classes;
};
__name(_ScrollPanelStyle, "ScrollPanelStyle");
__publicField(_ScrollPanelStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵScrollPanelStyle_BaseFactory;
  return /* @__PURE__ */ __name(function ScrollPanelStyle_Factory(__ngFactoryType__) {
  ...
  }, "ScrollPanelStyle_Factory");
})());
__publicField(_ScrollPanelStyle, "ɵprov", ɵɵdefineInjectable({
  token: _ScrollPanelStyle,
  factory: _ScrollPanelStyle.ɵfac
}));
var ScrollPanelStyle = _ScrollPanelStyle;
(() => {
...
var _ScrollPanel = class _ScrollPanel extends BaseComponent {
  /**
  ...
  scrollYRatio;
  scrollXRatio;
  timeoutFrame = /* @__PURE__ */ __name((fn) => setTimeout(fn, 0), "timeoutFrame");
  initialized = false;
  lastPageY;
  lastPageX;
  isXBarClicked = false;
...
__name(_ScrollPanel, "ScrollPanel");
__publicField(_ScrollPanel, "ɵfac", /* @__PURE__ */ (() => {
  let ɵScrollPanel_BaseFactory;
  return /* @__PURE__ */ __name(function ScrollPanel_Factory(__ngFactoryType__) {
...
__publicField(_ScrollPanel, "ɵcmp", ɵɵdefineComponent({
  ...
  contentQueries: /* @__PURE__ */ __name(function ScrollPanel_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "ScrollPanel_ContentQueries"),
  viewQuery: /* @__PURE__ */ __name(function ScrollPanel_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c0, 5);
      ɵɵviewQuery(_c1, 5);
      ɵɵviewQuery(_c2, 5);
  ...
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function ScrollPanel_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassMap(ctx.cn(ctx.cx("root"), ctx.styleClass));
    }
  }, "ScrollPanel_HostBindings"),
  inputs: {
  ...
  template: /* @__PURE__ */ __name(function ScrollPanel_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = ɵɵgetCurrentView();
      ɵɵprojectionDef();
      ɵɵelementStart(0, "div")(1, "div", 3, 0);
      ɵɵlistener("mouseenter", /* @__PURE__ */ __name(function ScrollPanel_Template_div_mouseenter_1_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.moveBar());
      }, "ScrollPanel_Template_div_mouseenter_1_listener"))("scroll", /* @__PURE__ */ __name(function ScrollPanel_Template_div_scroll_1_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onScroll($event));
      }, "ScrollPanel_Template_div_scroll_1_listener"));
      ...
      ɵɵlistener("mousedown", /* @__PURE__ */ __name(function ScrollPanel_Template_div_mousedown_5_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onXBarMouseDown($event));
      }, "ScrollPanel_Template_div_mousedown_5_listener"))("keydown", /* @__PURE__ */ __name(function ScrollPanel_Template_div_keydown_5_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onKeyDown($event));
      }, "ScrollPanel_Template_div_keydown_5_listener"))("keyup", /* @__PURE__ */ __name(function ScrollPanel_Template_div_keyup_5_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onKeyUp());
      }, "ScrollPanel_Template_div_keyup_5_listener"))("focus", /* @__PURE__ */ __name(function ScrollPanel_Template_div_focus_5_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onFocus($event));
      }, "ScrollPanel_Template_div_focus_5_listener"))("blur", /* @__PURE__ */ __name(function ScrollPanel_Template_div_blur_5_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onBlur());
      }, "ScrollPanel_Template_div_blur_5_listener"));
      ɵɵelementEnd();
      ɵɵelementStart(7, "div", 6, 2);
      ɵɵlistener("mousedown", /* @__PURE__ */ __name(function ScrollPanel_Template_div_mousedown_7_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onYBarMouseDown($event));
      }, "ScrollPanel_Template_div_mousedown_7_listener"))("keydown", /* @__PURE__ */ __name(function ScrollPanel_Template_div_keydown_7_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onKeyDown($event));
      }, "ScrollPanel_Template_div_keydown_7_listener"))("keyup", /* @__PURE__ */ __name(function ScrollPanel_Template_div_keyup_7_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onKeyUp());
      }, "ScrollPanel_Template_div_keyup_7_listener"))("focus", /* @__PURE__ */ __name(function ScrollPanel_Template_div_focus_7_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onFocus($event));
      }, "ScrollPanel_Template_div_focus_7_listener"));
      ɵɵelementEnd();
    }
    if (rf & 2) {
...
__name(_ScrollPanelModule, "ScrollPanelModule");
__publicField(_ScrollPanelModule, "ɵfac", /* @__PURE__ */ __name(function ScrollPanelModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ScrollPanelModule)();
}, "ScrollPanelModule_Factory"));
