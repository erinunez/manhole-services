...
__name(Timeline_div_0_ng_container_2_Template, "Timeline_div_0_ng_container_2_Template");
function Timeline_div_0_ng_container_4_ng_container_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Timeline_div_0_ng_container_4_ng_container_1_Template, "Timeline_div_0_ng_container_4_ng_container_1_Template");
...
__name(Timeline_div_0_ng_container_4_Template, "Timeline_div_0_ng_container_4_Template");
...
__name(Timeline_div_0_ng_template_5_Template, "Timeline_div_0_ng_template_5_Template");
...
__name(Timeline_div_0_div_7_Template, "Timeline_div_0_div_7_Template");
function Timeline_div_0_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(Timeline_div_0_ng_container_9_Template, "Timeline_div_0_ng_container_9_Template");
...
__name(Timeline_div_0_Template, "Timeline_div_0_Template");
var classes = {
  root: /* @__PURE__ */ __name(({
    instance
  }) => ["p-timeline p-component", "p-timeline-" + instance.align, "p-timeline-" + instance.layout], "root"),
...
var _TimelineStyle = class _TimelineStyle extends BaseStyle {
  name = "timeline";
  theme = style;
  classes = classes;
};
__name(_TimelineStyle, "TimelineStyle");
__publicField(_TimelineStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵTimelineStyle_BaseFactory;
  return /* @__PURE__ */ __name(function TimelineStyle_Factory(__ngFactoryType__) {
  ...
  }, "TimelineStyle_Factory");
})());
__publicField(_TimelineStyle, "ɵprov", ɵɵdefineInjectable({
  token: _TimelineStyle,
  factory: _TimelineStyle.ɵfac
}));
var TimelineStyle = _TimelineStyle;
(() => {
...
var _Timeline = class _Timeline extends BaseComponent {
  /**
...
__publicField(_Timeline, "ɵfac", /* @__PURE__ */ (() => {
  let ɵTimeline_BaseFactory;
  return /* @__PURE__ */ __name(function Timeline_Factory(__ngFactoryType__) {
...
__publicField(_Timeline, "ɵcmp", ɵɵdefineComponent({
  ...
  contentQueries: /* @__PURE__ */ __name(function Timeline_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "Timeline_ContentQueries"),
  hostVars: 4,
  hostBindings: /* @__PURE__ */ __name(function Timeline_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("data-pc-section", "root")("data-pc-name", "timeline");
      ɵɵclassMap(ctx.cn(ctx.cx("root"), ctx.styleClass));
    }
  }, "Timeline_HostBindings"),
  inputs: {
    value: "value",
  ...
  template: /* @__PURE__ */ __name(function Timeline_Template(rf, ctx) {
    if (rf & 1) {
...
__name(_TimelineModule, "TimelineModule");
__publicField(_TimelineModule, "ɵfac", /* @__PURE__ */ __name(function TimelineModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TimelineModule)();
}, "TimelineModule_Factory"));
