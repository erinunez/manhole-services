...
var _ObjectUtils = class _ObjectUtils {
...
__name(_ObjectUtils, "ObjectUtils");
var ObjectUtils = _ObjectUtils;
var lastId = 0;
...
function ZIndexUtils() {
  let zIndexes = [];
  const generateZIndex = /* @__PURE__ */ __name((key, baseZIndex) => {
  ...
  const getCurrentZIndex = /* @__PURE__ */ __name(() => {
    return zIndexes.length > 0 ? zIndexes[zIndexes.length - 1].value : 0;
  }, "getCurrentZIndex");
  const getZIndex = /* @__PURE__ */ __name((el) => {
    return el ? parseInt(el.style.zIndex, 10) || 0 : 0;
  }, "getZIndex");
  return {
    get: getZIndex,
    set: /* @__PURE__ */ __name((key, el, baseZIndex) => {
      if (el) {
        el.style.zIndex = String(generateZIndex(key, baseZIndex));
      }
    }, "set"),
    clear: /* @__PURE__ */ __name((el) => {
      if (el) {
        revertZIndex(getZIndex(el));
        el.style.zIndex = "";
      }
    }, "clear"),
    getCurrent: /* @__PURE__ */ __name(() => getCurrentZIndex(), "getCurrent"),
    generateZIndex,
    revertZIndex
  };
}
__name(ZIndexUtils, "ZIndexUtils");
var zindexutils = ZIndexUtils();
var transformToBoolean = /* @__PURE__ */ __name((value) => {
  return !!value;
}, "transformToBoolean");
var transformToNumber = /* @__PURE__ */ __name((value) => {
...
//# sourceMappingURL=chunk-DRXZWCSD.js.map
