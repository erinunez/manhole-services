...
function Chip_img_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("error", /* @__PURE__ */ __name(function Chip_img_1_Template_img_error_0_listener($event) {
      ɵɵrestoreView(_r1);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.imageError($event));
    }, "Chip_img_1_Template_img_error_0_listener"));
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext();
...
__name(Chip_img_1_Template, "Chip_img_1_Template");
...
__name(Chip_ng_template_2_span_0_Template, "Chip_ng_template_2_span_0_Template");
...
__name(Chip_ng_template_2_Template, "Chip_ng_template_2_Template");
...
__name(Chip_div_4_Template, "Chip_div_4_Template");
function Chip_ng_container_5_ng_container_1_span_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "span", 10);
    ɵɵlistener("click", /* @__PURE__ */ __name(function Chip_ng_container_5_ng_container_1_span_1_Template_span_click_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r1 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r1.close($event));
    }, "Chip_ng_container_5_ng_container_1_span_1_Template_span_click_0_listener"))("keydown", /* @__PURE__ */ __name(function Chip_ng_container_5_ng_container_1_span_1_Template_span_keydown_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r1 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r1.onKeydown($event));
    }, "Chip_ng_container_5_ng_container_1_span_1_Template_span_keydown_0_listener"));
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(3);
...
__name(Chip_ng_container_5_ng_container_1_span_1_Template, "Chip_ng_container_5_ng_container_1_span_1_Template");
function Chip_ng_container_5_ng_container_1__svg_svg_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = ɵɵgetCurrentView();
    ɵɵnamespaceSVG();
    ɵɵelementStart(0, "svg", 11);
    ɵɵlistener("click", /* @__PURE__ */ __name(function Chip_ng_container_5_ng_container_1__svg_svg_2_Template_svg_click_0_listener($event) {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r1.close($event));
    }, "Chip_ng_container_5_ng_container_1__svg_svg_2_Template_svg_click_0_listener"))("keydown", /* @__PURE__ */ __name(function Chip_ng_container_5_ng_container_1__svg_svg_2_Template_svg_keydown_0_listener($event) {
      ɵɵrestoreView(_r4);
      const ctx_r1 = ɵɵnextContext(3);
      return ɵɵresetView(ctx_r1.onKeydown($event));
    }, "Chip_ng_container_5_ng_container_1__svg_svg_2_Template_svg_keydown_0_listener"));
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = ɵɵnextContext(3);
...
__name(Chip_ng_container_5_ng_container_1__svg_svg_2_Template, "Chip_ng_container_5_ng_container_1__svg_svg_2_Template");
...
__name(Chip_ng_container_5_ng_container_1_Template, "Chip_ng_container_5_ng_container_1_Template");
function Chip_ng_container_5_span_2_1_ng_template_0_Template(rf, ctx) {
}
__name(Chip_ng_container_5_span_2_1_ng_template_0_Template, "Chip_ng_container_5_span_2_1_ng_template_0_Template");
...
__name(Chip_ng_container_5_span_2_1_Template, "Chip_ng_container_5_span_2_1_Template");
function Chip_ng_container_5_span_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "span", 12);
    ɵɵlistener("click", /* @__PURE__ */ __name(function Chip_ng_container_5_span_2_Template_span_click_0_listener($event) {
      ɵɵrestoreView(_r5);
      const ctx_r1 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r1.close($event));
    }, "Chip_ng_container_5_span_2_Template_span_click_0_listener"))("keydown", /* @__PURE__ */ __name(function Chip_ng_container_5_span_2_Template_span_keydown_0_listener($event) {
      ɵɵrestoreView(_r5);
      const ctx_r1 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r1.onKeydown($event));
    }, "Chip_ng_container_5_span_2_Template_span_keydown_0_listener"));
...
__name(Chip_ng_container_5_span_2_Template, "Chip_ng_container_5_span_2_Template");
...
__name(Chip_ng_container_5_Template, "Chip_ng_container_5_Template");
var classes = {
  root: /* @__PURE__ */ __name(() => ["p-chip p-component"], "root"),
  image: "p-chip-image",
  icon: "p-chip-icon",
  label: "p-chip-label",
  removeIcon: "p-chip-remove-icon"
};
var _ChipStyle = class _ChipStyle extends BaseStyle {
  name = "chip";
  theme = style;
  classes = classes;
};
__name(_ChipStyle, "ChipStyle");
__publicField(_ChipStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵChipStyle_BaseFactory;
  return /* @__PURE__ */ __name(function ChipStyle_Factory(__ngFactoryType__) {
    return (ɵChipStyle_BaseFactory || (ɵChipStyle_BaseFactory = ɵɵgetInheritedFactory(_ChipStyle)))(__ngFactoryType__ || _ChipStyle);
  }, "ChipStyle_Factory");
})());
__publicField(_ChipStyle, "ɵprov", ɵɵdefineInjectable({
  token: _ChipStyle,
  factory: _ChipStyle.ɵfac
}));
var ChipStyle = _ChipStyle;
(() => {
...
var _Chip = class _Chip extends BaseComponent {
  /**
...
__name(_Chip, "Chip");
__publicField(_Chip, "ɵfac", /* @__PURE__ */ (() => {
  let ɵChip_BaseFactory;
  return /* @__PURE__ */ __name(function Chip_Factory(__ngFactoryType__) {
...
__publicField(_Chip, "ɵcmp", ɵɵdefineComponent({
  type: _Chip,
  selectors: [["p-chip"]],
  contentQueries: /* @__PURE__ */ __name(function Chip_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  hostVars: 7,
  hostBindings: /* @__PURE__ */ __name(function Chip_HostBindings(rf, ctx) {
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function Chip_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
      ɵɵprojection(0);
...
__name(_ChipModule, "ChipModule");
__publicField(_ChipModule, "ɵfac", /* @__PURE__ */ __name(function ChipModule_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-YSYNKMO5.js.map
