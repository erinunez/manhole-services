...
var _RippleStyle = class _RippleStyle extends BaseStyle {
  name = "ripple";
  theme = theme;
  classes = classes;
};
__name(_RippleStyle, "RippleStyle");
__publicField(_RippleStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵRippleStyle_BaseFactory;
  return /* @__PURE__ */ __name(function RippleStyle_Factory(__ngFactoryType__) {
...
__publicField(_RippleStyle, "ɵprov", ɵɵdefineInjectable({
  token: _RippleStyle,
  factory: _RippleStyle.ɵfac
}));
var RippleStyle = _RippleStyle;
(() => {
...
var _Ripple = class _Ripple extends BaseComponent {
  zone = inject(NgZone);
...
__name(_Ripple, "Ripple");
__publicField(_Ripple, "ɵfac", /* @__PURE__ */ __name(function Ripple_Factory(__ngFactoryType__) {
...
__name(_RippleModule, "RippleModule");
__publicField(_RippleModule, "ɵfac", /* @__PURE__ */ __name(function RippleModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _RippleModule)();
}, "RippleModule_Factory"));
...
//# sourceMappingURL=chunk-ZBNJILLB.js.map
