...
__name(SelectButton_For_1_Conditional_1_ng_template_0_ng_container_0_Template, "SelectButton_For_1_Conditional_1_ng_template_0_ng_container_0_Template");
...
__name(SelectButton_For_1_Conditional_1_ng_template_0_Template, "SelectButton_For_1_Conditional_1_ng_template_0_Template");
...
__name(SelectButton_For_1_Conditional_1_Template, "SelectButton_For_1_Conditional_1_Template");
function SelectButton_For_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "p-togglebutton", 2);
    ɵɵlistener("onChange", /* @__PURE__ */ __name(function SelectButton_For_1_Template_p_togglebutton_onChange_0_listener($event) {
    ...
    }, "SelectButton_For_1_Template_p_togglebutton_onChange_0_listener"));
...
__name(SelectButton_For_1_Template, "SelectButton_For_1_Template");
var theme = (
  /*css*/
  `
    ${style}
...
var _SelectButtonStyle = class _SelectButtonStyle extends BaseStyle {
  name = "selectbutton";
  theme = theme;
  classes = classes;
};
__name(_SelectButtonStyle, "SelectButtonStyle");
__publicField(_SelectButtonStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵSelectButtonStyle_BaseFactory;
  return /* @__PURE__ */ __name(function SelectButtonStyle_Factory(__ngFactoryType__) {
  ...
  }, "SelectButtonStyle_Factory");
})());
__publicField(_SelectButtonStyle, "ɵprov", ɵɵdefineInjectable({
  token: _SelectButtonStyle,
  factory: _SelectButtonStyle.ɵfac
}));
var SelectButtonStyle = _SelectButtonStyle;
(() => {
...
var _SelectButton = class _SelectButton extends BaseEditableHolder {
  /**
...
__name(_SelectButton, "SelectButton");
__publicField(_SelectButton, "ɵfac", /* @__PURE__ */ (() => {
  let ɵSelectButton_BaseFactory;
  return /* @__PURE__ */ __name(function SelectButton_Factory(__ngFactoryType__) {
...
__publicField(_SelectButton, "ɵcmp", ɵɵdefineComponent({
  ...
  }, "SelectButton_ContentQueries"),
  hostVars: 6,
  hostBindings: /* @__PURE__ */ __name(function SelectButton_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("role", "group")("aria-labelledby", ctx.ariaLabelledBy)("data-pc-section", "root")("data-pc-name", "selectbutton");
      ɵɵclassMap(ctx.cx("root"));
    }
  }, "SelectButton_HostBindings"),
  inputs: {
    options: "options",
  ...
  template: /* @__PURE__ */ __name(function SelectButton_Template(rf, ctx) {
    if (rf & 1) {
...
__name(_SelectButtonModule, "SelectButtonModule");
__publicField(_SelectButtonModule, "ɵfac", /* @__PURE__ */ __name(function SelectButtonModule_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-2WLAS5GX.js.map
