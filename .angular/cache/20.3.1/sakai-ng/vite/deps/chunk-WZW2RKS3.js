...
var _BaseComponentStyle = class _BaseComponentStyle extends BaseStyle {
  name = "common";
};
__name(_BaseComponentStyle, "BaseComponentStyle");
__publicField(_BaseComponentStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵBaseComponentStyle_BaseFactory;
  return /* @__PURE__ */ __name(function BaseComponentStyle_Factory(__ngFactoryType__) {
...
__publicField(_BaseComponentStyle, "ɵprov", ɵɵdefineInjectable({
  token: _BaseComponentStyle,
  factory: _BaseComponentStyle.ɵfac,
  providedIn: "root"
}));
var BaseComponentStyle = _BaseComponentStyle;
(() => {
...
__name(_BaseComponent, "BaseComponent");
__publicField(_BaseComponent, "ɵfac", /* @__PURE__ */ __name(function BaseComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _BaseComponent)();
}, "BaseComponent_Factory"));
__publicField(_BaseComponent, "ɵdir", ɵɵdefineDirective({
  type: _BaseComponent,
  inputs: {
    dt: "dt"
  },
...
//# sourceMappingURL=chunk-WZW2RKS3.js.map
