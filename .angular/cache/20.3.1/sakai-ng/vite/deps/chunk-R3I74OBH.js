...
var _TooltipStyle = class _TooltipStyle extends BaseStyle {
  name = "tooltip";
  theme = style;
  classes = classes;
};
__name(_TooltipStyle, "TooltipStyle");
__publicField(_TooltipStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵTooltipStyle_BaseFactory;
  return /* @__PURE__ */ __name(function TooltipStyle_Factory(__ngFactoryType__) {
  ...
  }, "TooltipStyle_Factory");
})());
__publicField(_TooltipStyle, "ɵprov", ɵɵdefineInjectable({
  token: _TooltipStyle,
...
var _Tooltip = class _Tooltip extends BaseComponent {
  zone;
  viewContainer;
  /**
...
__publicField(_Tooltip, "ɵfac", /* @__PURE__ */ __name(function Tooltip_Factory(__ngFactoryType__) {
...
__name(_TooltipModule, "TooltipModule");
__publicField(_TooltipModule, "ɵfac", /* @__PURE__ */ __name(function TooltipModule_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-R3I74OBH.js.map
