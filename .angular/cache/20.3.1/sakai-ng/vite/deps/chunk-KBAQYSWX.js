...
__name(Checkbox_ng_container_3_ng_container_1_span_1_Template, "Checkbox_ng_container_3_ng_container_1_span_1_Template");
...
__name(Checkbox_ng_container_3_ng_container_1__svg_svg_2_Template, "Checkbox_ng_container_3_ng_container_1__svg_svg_2_Template");
...
__name(Checkbox_ng_container_3_ng_container_1_Template, "Checkbox_ng_container_3_ng_container_1_Template");
...
__name(Checkbox_ng_container_3__svg_svg_2_Template, "Checkbox_ng_container_3__svg_svg_2_Template");
...
__name(Checkbox_ng_container_3_Template, "Checkbox_ng_container_3_Template");
function Checkbox_4_ng_template_0_Template(rf, ctx) {
}
__name(Checkbox_4_ng_template_0_Template, "Checkbox_4_ng_template_0_Template");
function Checkbox_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, Checkbox_4_ng_template_0_Template, 0, 0, "ng-template");
  }
}
__name(Checkbox_4_Template, "Checkbox_4_Template");
var theme = (
  /*css*/
  `
    ${style}
...
var _CheckboxStyle = class _CheckboxStyle extends BaseStyle {
  name = "checkbox";
  theme = theme;
  classes = classes;
};
__name(_CheckboxStyle, "CheckboxStyle");
__publicField(_CheckboxStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵCheckboxStyle_BaseFactory;
  return /* @__PURE__ */ __name(function CheckboxStyle_Factory(__ngFactoryType__) {
  ...
  }, "CheckboxStyle_Factory");
})());
__publicField(_CheckboxStyle, "ɵprov", ɵɵdefineInjectable({
  token: _CheckboxStyle,
  factory: _CheckboxStyle.ɵfac
}));
var CheckboxStyle = _CheckboxStyle;
(() => {
...
var _Checkbox = class _Checkbox extends BaseEditableHolder {
  /**
...
__publicField(_Checkbox, "ɵfac", /* @__PURE__ */ (() => {
  let ɵCheckbox_BaseFactory;
  return /* @__PURE__ */ __name(function Checkbox_Factory(__ngFactoryType__) {
...
__publicField(_Checkbox, "ɵcmp", ɵɵdefineComponent({
  ...
  contentQueries: /* @__PURE__ */ __name(function Checkbox_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "Checkbox_ContentQueries"),
  viewQuery: /* @__PURE__ */ __name(function Checkbox_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c1, 5);
    }
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function Checkbox_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = ɵɵgetCurrentView();
      ɵɵelementStart(0, "input", 1, 0);
      ɵɵlistener("focus", /* @__PURE__ */ __name(function Checkbox_Template_input_focus_0_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onInputFocus($event));
      }, "Checkbox_Template_input_focus_0_listener"))("blur", /* @__PURE__ */ __name(function Checkbox_Template_input_blur_0_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onInputBlur($event));
      }, "Checkbox_Template_input_blur_0_listener"))("change", /* @__PURE__ */ __name(function Checkbox_Template_input_change_0_listener($event) {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.handleChange($event));
      }, "Checkbox_Template_input_change_0_listener"));
      ɵɵelementEnd();
...
__name(_CheckboxModule, "CheckboxModule");
__publicField(_CheckboxModule, "ɵfac", /* @__PURE__ */ __name(function CheckboxModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CheckboxModule)();
}, "CheckboxModule_Factory"));
...
//# sourceMappingURL=chunk-KBAQYSWX.js.map
