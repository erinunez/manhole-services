...
__name(ProgressBar_div_0_div_2_Template, "ProgressBar_div_0_div_2_Template");
function ProgressBar_div_0_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(ProgressBar_div_0_ng_container_3_Template, "ProgressBar_div_0_ng_container_3_Template");
...
__name(ProgressBar_div_0_Template, "ProgressBar_div_0_Template");
...
__name(ProgressBar_div_1_Template, "ProgressBar_div_1_Template");
var classes = {
...
var _ProgressBarStyle = class _ProgressBarStyle extends BaseStyle {
  name = "progressbar";
  theme = style;
  classes = classes;
};
__name(_ProgressBarStyle, "ProgressBarStyle");
__publicField(_ProgressBarStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵProgressBarStyle_BaseFactory;
  return /* @__PURE__ */ __name(function ProgressBarStyle_Factory(__ngFactoryType__) {
  ...
  }, "ProgressBarStyle_Factory");
})());
__publicField(_ProgressBarStyle, "ɵprov", ɵɵdefineInjectable({
  token: _ProgressBarStyle,
  factory: _ProgressBarStyle.ɵfac
}));
var ProgressBarStyle = _ProgressBarStyle;
(() => {
...
var _ProgressBar = class _ProgressBar extends BaseComponent {
  /**
...
__publicField(_ProgressBar, "ɵfac", /* @__PURE__ */ (() => {
  let ɵProgressBar_BaseFactory;
  return /* @__PURE__ */ __name(function ProgressBar_Factory(__ngFactoryType__) {
...
__publicField(_ProgressBar, "ɵcmp", ɵɵdefineComponent({
  ...
  contentQueries: /* @__PURE__ */ __name(function ProgressBar_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "ProgressBar_ContentQueries"),
  hostVars: 8,
  hostBindings: /* @__PURE__ */ __name(function ProgressBar_HostBindings(rf, ctx) {
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function ProgressBar_Template(rf, ctx) {
    if (rf & 1) {
...
__name(_ProgressBarModule, "ProgressBarModule");
__publicField(_ProgressBarModule, "ɵfac", /* @__PURE__ */ __name(function ProgressBarModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ProgressBarModule)();
}, "ProgressBarModule_Factory"));
...
//# sourceMappingURL=chunk-3ADPZQBG.js.map
