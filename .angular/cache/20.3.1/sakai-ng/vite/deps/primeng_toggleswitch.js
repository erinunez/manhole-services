...
__name(ToggleSwitch_Conditional_4_ng_container_0_Template, "ToggleSwitch_Conditional_4_ng_container_0_Template");
...
__name(ToggleSwitch_Conditional_4_Template, "ToggleSwitch_Conditional_4_Template");
var theme = (
  /*css*/
  `
    ${style}
...
var _ToggleSwitchStyle = class _ToggleSwitchStyle extends BaseStyle {
  name = "toggleswitch";
  theme = theme;
  classes = classes;
  inlineStyles = inlineStyles;
};
__name(_ToggleSwitchStyle, "ToggleSwitchStyle");
__publicField(_ToggleSwitchStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵToggleSwitchStyle_BaseFactory;
  return /* @__PURE__ */ __name(function ToggleSwitchStyle_Factory(__ngFactoryType__) {
  ...
  }, "ToggleSwitchStyle_Factory");
})());
__publicField(_ToggleSwitchStyle, "ɵprov", ɵɵdefineInjectable({
  token: _ToggleSwitchStyle,
  factory: _ToggleSwitchStyle.ɵfac
}));
var ToggleSwitchStyle = _ToggleSwitchStyle;
(() => {
...
var _ToggleSwitch = class _ToggleSwitch extends BaseEditableHolder {
  /**
...
__name(_ToggleSwitch, "ToggleSwitch");
__publicField(_ToggleSwitch, "ɵfac", /* @__PURE__ */ (() => {
  let ɵToggleSwitch_BaseFactory;
  return /* @__PURE__ */ __name(function ToggleSwitch_Factory(__ngFactoryType__) {
  ...
  }, "ToggleSwitch_Factory");
})());
__publicField(_ToggleSwitch, "ɵcmp", ɵɵdefineComponent({
  type: _ToggleSwitch,
  selectors: [["p-toggleswitch"], ["p-toggleSwitch"], ["p-toggle-switch"]],
  contentQueries: /* @__PURE__ */ __name(function ToggleSwitch_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "ToggleSwitch_ContentQueries"),
  viewQuery: /* @__PURE__ */ __name(function ToggleSwitch_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c1, 5);
    }
    if (rf & 2) {
  ...
  hostVars: 6,
  hostBindings: /* @__PURE__ */ __name(function ToggleSwitch_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("click", /* @__PURE__ */ __name(function ToggleSwitch_click_HostBindingHandler($event) {
        return ctx.onHostClick($event);
      }, "ToggleSwitch_click_HostBindingHandler"));
    }
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function ToggleSwitch_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = ɵɵgetCurrentView();
      ɵɵelementStart(0, "input", 1, 0);
      ɵɵlistener("focus", /* @__PURE__ */ __name(function ToggleSwitch_Template_input_focus_0_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onFocus());
      }, "ToggleSwitch_Template_input_focus_0_listener"))("blur", /* @__PURE__ */ __name(function ToggleSwitch_Template_input_blur_0_listener() {
        ɵɵrestoreView(_r1);
        return ɵɵresetView(ctx.onBlur());
      }, "ToggleSwitch_Template_input_blur_0_listener"));
      ɵɵelementEnd();
...
var _ToggleSwitchModule = class _ToggleSwitchModule {
};
__name(_ToggleSwitchModule, "ToggleSwitchModule");
__publicField(_ToggleSwitchModule, "ɵfac", /* @__PURE__ */ __name(function ToggleSwitchModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ToggleSwitchModule)();
}, "ToggleSwitchModule_Factory"));
__publicField(_ToggleSwitchModule, "ɵmod", ɵɵdefineNgModule({
  type: _ToggleSwitchModule,
  imports: [ToggleSwitch, SharedModule],
  exports: [ToggleSwitch, SharedModule]
}));
__publicField(_ToggleSwitchModule, "ɵinj", ɵɵdefineInjector({
  imports: [ToggleSwitch, SharedModule, SharedModule]
}));
var ToggleSwitchModule = _ToggleSwitchModule;
(() => {
