...
var _DomHandler = class _DomHandler {
  ...
  static relativePosition(element, target, gutter = true) {
    const getClosestRelativeElement = /* @__PURE__ */ __name((el) => {
      if (!el)
        return;
  ...
  static getScrollableParents(element) {
    ...
    if (element) {
      ...
      const overflowCheck = /* @__PURE__ */ __name((node) => {
  ...
  static getTargetElement(target, el) {
    ...
    switch (target) {
      ...
      default:
        ...
        const isFunction = /* @__PURE__ */ __name((obj) => !!(obj && obj.constructor && obj.call && obj.apply), "isFunction");
  ...
  static setAttributes(element, attributes = {}) {
    if (this.isElement(element)) {
      const computedStyles = /* @__PURE__ */ __name((rule, value) => {
...
var _ConnectedOverlayScrollHandler = class _ConnectedOverlayScrollHandler {
  element;
  listener;
  scrollableParents;
...
__name(_ConnectedOverlayScrollHandler, "ConnectedOverlayScrollHandler");
var ConnectedOverlayScrollHandler = _ConnectedOverlayScrollHandler;
...
//# sourceMappingURL=chunk-MNBMOPCT.js.map
