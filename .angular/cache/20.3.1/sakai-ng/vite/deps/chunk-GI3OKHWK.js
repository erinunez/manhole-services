...
__name(ToggleButton_ng_container_1_Template, "ToggleButton_ng_container_1_Template");
...
__name(ToggleButton_Conditional_2_Conditional_0_Conditional_0_Template, "ToggleButton_Conditional_2_Conditional_0_Conditional_0_Template");
...
__name(ToggleButton_Conditional_2_Conditional_0_Template, "ToggleButton_Conditional_2_Conditional_0_Template");
function ToggleButton_Conditional_2_Conditional_1_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0);
  }
}
__name(ToggleButton_Conditional_2_Conditional_1_ng_container_0_Template, "ToggleButton_Conditional_2_Conditional_1_ng_container_0_Template");
...
__name(ToggleButton_Conditional_2_Conditional_1_Template, "ToggleButton_Conditional_2_Conditional_1_Template");
...
__name(ToggleButton_Conditional_2_Template, "ToggleButton_Conditional_2_Template");
var theme = (
  /*css*/
  `
    ${style}
...
var _ToggleButtonStyle = class _ToggleButtonStyle extends BaseStyle {
  name = "togglebutton";
  theme = theme;
  classes = classes;
};
__name(_ToggleButtonStyle, "ToggleButtonStyle");
__publicField(_ToggleButtonStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵToggleButtonStyle_BaseFactory;
  return /* @__PURE__ */ __name(function ToggleButtonStyle_Factory(__ngFactoryType__) {
  ...
  }, "ToggleButtonStyle_Factory");
})());
__publicField(_ToggleButtonStyle, "ɵprov", ɵɵdefineInjectable({
  token: _ToggleButtonStyle,
  factory: _ToggleButtonStyle.ɵfac
}));
var ToggleButtonStyle = _ToggleButtonStyle;
(() => {
...
var _ToggleButton = class _ToggleButton extends BaseEditableHolder {
  onKeyDown(event) {
    switch (event.code) {
      case "Enter":
        this.toggle(event);
...
__publicField(_ToggleButton, "ɵfac", /* @__PURE__ */ (() => {
  let ɵToggleButton_BaseFactory;
  return /* @__PURE__ */ __name(function ToggleButton_Factory(__ngFactoryType__) {
...
__publicField(_ToggleButton, "ɵcmp", ɵɵdefineComponent({
  ...
  }, "ToggleButton_ContentQueries"),
  hostVars: 6,
  hostBindings: /* @__PURE__ */ __name(function ToggleButton_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("keydown", /* @__PURE__ */ __name(function ToggleButton_keydown_HostBindingHandler($event) {
        return ctx.onKeyDown($event);
      }, "ToggleButton_keydown_HostBindingHandler"))("click", /* @__PURE__ */ __name(function ToggleButton_click_HostBindingHandler($event) {
        return ctx.toggle($event);
      }, "ToggleButton_click_HostBindingHandler"));
    }
    if (rf & 2) {
      ɵɵattribute("aria-labelledby", ctx.ariaLabelledBy)("aria-pressed", ctx.checked)("role", "button")("tabindex", !ctx.$disabled() ? 0 : -1);
      ɵɵclassMap(ctx.cn(ctx.cx("root"), ctx.styleClass));
    }
  }, "ToggleButton_HostBindings"),
  inputs: {
    onLabel: "onLabel",
    offLabel: "offLabel",
    onIcon: "onIcon",
  ...
  template: /* @__PURE__ */ __name(function ToggleButton_Template(rf, ctx) {
    if (rf & 1) {
...
__name(_ToggleButtonModule, "ToggleButtonModule");
__publicField(_ToggleButtonModule, "ɵfac", /* @__PURE__ */ __name(function ToggleButtonModule_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-GI3OKHWK.js.map
