...
var _TextareaStyle = class _TextareaStyle extends BaseStyle {
  name = "textarea";
  theme = theme;
  classes = classes;
};
__name(_TextareaStyle, "TextareaStyle");
__publicField(_TextareaStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵTextareaStyle_BaseFactory;
  return /* @__PURE__ */ __name(function TextareaStyle_Factory(__ngFactoryType__) {
  ...
  }, "TextareaStyle_Factory");
})());
__publicField(_TextareaStyle, "ɵprov", ɵɵdefineInjectable({
  token: _TextareaStyle,
  factory: _TextareaStyle.ɵfac
}));
var TextareaStyle = _TextareaStyle;
(() => {
...
var _Textarea = class _Textarea extends BaseModelHolder {
  /**
...
__publicField(_Textarea, "ɵfac", /* @__PURE__ */ (() => {
  let ɵTextarea_BaseFactory;
  return /* @__PURE__ */ __name(function Textarea_Factory(__ngFactoryType__) {
    return (ɵTextarea_BaseFactory || (ɵTextarea_BaseFactory = ɵɵgetInheritedFactory(_Textarea)))(__ngFactoryType__ || _Textarea);
  }, "Textarea_Factory");
})());
__publicField(_Textarea, "ɵdir", ɵɵdefineDirective({
  type: _Textarea,
  selectors: [["", "pTextarea", ""], ["", "pInputTextarea", ""]],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function Textarea_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("input", /* @__PURE__ */ __name(function Textarea_input_HostBindingHandler($event) {
        return ctx.onInput($event);
      }, "Textarea_input_HostBindingHandler"));
    }
    if (rf & 2) {
      ɵɵclassMap(ctx.cx("root"));
    }
  }, "Textarea_HostBindings"),
  inputs: {
...
var _TextareaModule = class _TextareaModule {
};
__name(_TextareaModule, "TextareaModule");
__publicField(_TextareaModule, "ɵfac", /* @__PURE__ */ __name(function TextareaModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _TextareaModule)();
}, "TextareaModule_Factory"));
__publicField(_TextareaModule, "ɵmod", ɵɵdefineNgModule({
  type: _TextareaModule,
  imports: [Textarea],
  exports: [Textarea]
}));
__publicField(_TextareaModule, "ɵinj", ɵɵdefineInjector({}));
var TextareaModule = _TextareaModule;
(() => {
