...
var _InputGroupStyle = class _InputGroupStyle extends BaseStyle {
  name = "inputgroup";
  theme = theme;
  classes = classes;
};
__name(_InputGroupStyle, "InputGroupStyle");
__publicField(_InputGroupStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵInputGroupStyle_BaseFactory;
  return /* @__PURE__ */ __name(function InputGroupStyle_Factory(__ngFactoryType__) {
  ...
  }, "InputGroupStyle_Factory");
})());
__publicField(_InputGroupStyle, "ɵprov", ɵɵdefineInjectable({
  token: _InputGroupStyle,
  factory: _InputGroupStyle.ɵfac
}));
var InputGroupStyle = _InputGroupStyle;
(() => {
...
var _InputGroup = class _InputGroup extends BaseComponent {
  /**
...
__name(_InputGroup, "InputGroup");
__publicField(_InputGroup, "ɵfac", /* @__PURE__ */ (() => {
  let ɵInputGroup_BaseFactory;
  return /* @__PURE__ */ __name(function InputGroup_Factory(__ngFactoryType__) {
...
__publicField(_InputGroup, "ɵcmp", ɵɵdefineComponent({
  ...
  hostVars: 3,
  hostBindings: /* @__PURE__ */ __name(function InputGroup_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("data-pc-name", "inputgroup");
      ɵɵclassMap(ctx.cn(ctx.cx("root"), ctx.styleClass));
    }
  }, "InputGroup_HostBindings"),
  inputs: {
  ...
  decls: 1,
  vars: 0,
  template: /* @__PURE__ */ __name(function InputGroup_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
      ɵɵprojection(0);
    }
...
__name(_InputGroupModule, "InputGroupModule");
__publicField(_InputGroupModule, "ɵfac", /* @__PURE__ */ __name(function InputGroupModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _InputGroupModule)();
}, "InputGroupModule_Factory"));
