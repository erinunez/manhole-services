...
var _BadgeStyle = class _BadgeStyle extends BaseStyle {
  name = "badge";
  theme = theme;
  classes = classes;
};
__name(_BadgeStyle, "BadgeStyle");
__publicField(_BadgeStyle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵBadgeStyle_BaseFactory;
  return /* @__PURE__ */ __name(function BadgeStyle_Factory(__ngFactoryType__) {
    return (ɵBadgeStyle_BaseFactory || (ɵBadgeStyle_BaseFactory = ɵɵgetInheritedFactory(_BadgeStyle)))(__ngFactoryType__ || _BadgeStyle);
  }, "BadgeStyle_Factory");
})());
__publicField(_BadgeStyle, "ɵprov", ɵɵdefineInjectable({
  token: _BadgeStyle,
  factory: _BadgeStyle.ɵfac
}));
var BadgeStyle = _BadgeStyle;
(() => {
...
var _BadgeDirective = class _BadgeDirective extends BaseComponent {
  /**
...
__name(_BadgeDirective, "BadgeDirective");
__publicField(_BadgeDirective, "ɵfac", /* @__PURE__ */ __name(function BadgeDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _BadgeDirective)();
}, "BadgeDirective_Factory"));
...
var _Badge = class _Badge extends BaseComponent {
  /**
   * Class of the element.
...
__name(_Badge, "Badge");
__publicField(_Badge, "ɵfac", /* @__PURE__ */ (() => {
  let ɵBadge_BaseFactory;
  return /* @__PURE__ */ __name(function Badge_Factory(__ngFactoryType__) {
...
__publicField(_Badge, "ɵcmp", ɵɵdefineComponent({
  ...
  selectors: [["p-badge"]],
  hostVars: 4,
  hostBindings: /* @__PURE__ */ __name(function Badge_HostBindings(rf, ctx) {
    if (rf & 2) {
  ...
  decls: 1,
  vars: 1,
  template: /* @__PURE__ */ __name(function Badge_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtext(0);
    }
    if (rf & 2) {
...
__name(_BadgeModule, "BadgeModule");
__publicField(_BadgeModule, "ɵfac", /* @__PURE__ */ __name(function BadgeModule_Factory(__ngFactoryType__) {
...
//# sourceMappingURL=chunk-WVZHJMTZ.js.map
