...
@Component({
    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <a class="layout-topbar-logo" routerLink="/map-view">
                ...
                <!-- <img src="assets/icons/tnb-logo.jpg" alt="logo"  /> -->
                <img src="assets/icons/tnb-logo-black-transparent.png" alt="tnb" style="width: 70px;"/>
                <!-- <span>Manhole Service</span> -->
            </a>
        </div>
        ...
        <div class="layout-topbar-actions">
            ...
            <button style="display: none;" class="layout-topbar-menu-button layout-topbar-action" pStyleClass="@next" enterFromClass="hidden" enterActiveClass="animate-scalein" leaveToClass="hidden" leaveActiveClass="animate-fadeout" [hideOnOutsideClick]="true">
